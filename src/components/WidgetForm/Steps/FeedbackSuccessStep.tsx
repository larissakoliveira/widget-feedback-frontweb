...
export function FeedbackSuccessStep({restartFeedback}: FeedbackSuccessStepProps) {
    return (
        <>
            ...
            <div className="flex flex-col items-center py-10 w=[30px]">
                ...
                <button className="py-2 px-6 mt-6 bg-zinc-800 rounded-md border-transparent text-sm leading-6 
